...
<TABLE border='0' width='600'>
	<TR>
		...
		<%
			if(myId.equals(id)) {
		%>
			<a href="main.jsp?menu=noti&subMenu=calendar&action=reset&num=<%=num %>">[수정하기]</a>
			<a href="main.jsp?menu=noti&subMenu=calendar&action=delete&num=<%=num %>">[삭제하기]</a>
		<%
			} else {
		%>
			[수정하기]
		...
		<TD align='right'>
			<a href="main.jsp?menu=noti&subMenu=calendar">[목록보기]</a>
 		</TD>
	</TR>
</TABLE>
...
<FORM Name='Plus' Action='menu/noti/noti_comment_input.jsp' Method='post'>
...
String strSQL = "SELECT * FROM noti_comment6 WHERE id = '" + num + "'";
...
%>
				<FORM Name='reset' Action='menu/noti/noti_comment_reset.jsp' Method='post'>
...
%>
		...
		%>
		 	<a href="main.jsp?menu=noti&subMenu=calendar&action=read&num=<%=num %>&subAction=comment_reset&commentNum=<%=getCommentNum %>">[수정하기]</a>
		 	<a href="menu/noti/noti_comment_delete.jsp?commentNum=<%=getCommentNum %>&num=<%=num %>">[삭제하기]</a>
		<%
			} else {
		%>
			[수정하기]

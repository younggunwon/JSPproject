...
<%
	...
	ConnectDatabase cd = new ConnectDatabase("noti_food6");
...
<FORM Name='Write' Action='menu/food/noti_food_reset_input.jsp' Method='post' Enctype='multipart/form-data' OnSubmit='return Check()'>

...
<%
	...
	ConnectDatabase cd = new ConnectDatabase("free_free6");
...
<FORM Name='Write' Action='menu/free/free_reset_input.jsp' Method='post' Enctype='multipart/form-data' OnSubmit='return Check()'>
